...
chroot /media/fakeinstallroot /usr/bin/bash -c "source /build/addFunction.tmp;setup_distcc;cd /build/sddm;mkdir build;cd /build/sddm/build;cmake -DCMAKE_BUILD_TYPE=Release -S ../ -DCMAKE_PREFIX_PATH=/usr -DCMAKE_INSTALL_PREFIX=/usr;make;make install"
